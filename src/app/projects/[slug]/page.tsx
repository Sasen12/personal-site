  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16 sm:py-24">
      ...
      <div className="mb-12 flex flex-wrap gap-4">
        ...
        {project.github && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-xl border border-gray-300 px-5 py-2.5 text-sm font-medium transition-all hover:border-indigo-300 hover:text-indigo-600 dark:border-gray-700 dark:hover:border-indigo-600 dark:hover:text-indigo-400"
          >
            Source Code
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
          </a>
      ...
      <AnimatedSection delay={0.5}>
        <div className="mb-12 rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-800 dark:bg-gray-900">
          <h2 className="mb-3 text-lg font-semibold">About</h2>
          <p className="leading-relaxed text-gray-600 dark:text-gray-400">{project.details}</p>
        </div>
      </AnimatedSection>
      )}
